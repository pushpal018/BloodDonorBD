...
public class DonorData {
    ...
    private String LastDonate, Name, Contact, UID, Address,imageURL;
    ...
    public DonorData(int totalDonate, String imageURL, String lastDonate, String Name, String Contact, String Address, String UID) {
